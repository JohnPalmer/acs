...
G2009 = rbindlist(lapply(stateTLs, function(s) as.data.table(read.fwf(paste0("~/research/acs/untracked_data/2005-2009/Tracks_Block_Groups/g20095", s, ".txt"),  widths=c(6,2,3,2, 7, -1,-1,-1,2,2,3,5,5, 6, -122, 5, -5, -40, 200, -50), col.names=c("FILEID", "STUSAB", "SUMLEVEL", "COMPONENT", "LOGRECNO", "STATECE", "STATE", "COUNTY", "COUSUB", "PLACE", "TRACT", "PUMA5", "Name"), colClasses="character", header = FALSE, fileEncoding="ISO-8859-1"))))
