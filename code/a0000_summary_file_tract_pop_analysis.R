...
G2009 = rbindlist(lapply(stateTLs, function(s) as.data.table(read.fwf(paste0("~/research/acs/untracked_data/2005-2009/Tracks_Block_Groups/g20095", s, ".txt"),  widths=c(6,2,3,2, 7, -20, 6, -172, 200, -50), col.names=c("FILEID", "STUSAB", "SUMLEVEL", "COMPONENT", "LOGRECNO", "TRACT", "Name"), colClasses="character", header = FALSE, fileEncoding="ISO-8859-1"))))
               
E2009 = rbindlist(lapply(stateTLs, function(s) fread(paste0("~/research/acs/untracked_data/2005-2009/Tracks_Block_Groups/e20095", s, "0018000.txt"), na.strings = c(".", " ", "NA", "N/A"), colClasses = c(rep("NULL", 2), "character", rep("NULL", 2), "character", rep("NULL", 59), "numeric", rep("NULL", 160)), col.names = c("STUSAB", "LOGRECNO", "N_Bos"))))
...
M2009 = rbindlist(lapply(stateTLs, function(s) fread(paste0("~/research/acs/untracked_data/2005-2009/Tracks_Block_Groups/m20095", s, "0018000.txt"), na.strings = c(".", " ", "NA", "N/A"), colClasses = c(rep("NULL", 2), "character", rep("NULL", 2), "character", rep("NULL", 59), "numeric", rep("NULL", 160)), col.names = c("STUSAB", "LOGRECNO", "N_Bos_ME90"))))
...
G2016 = rbindlist(lapply(stateTLs, function(s) fread(paste0("~/research/acs/data/ACS_2016_geography_files/g20165", s, ".csv"), colClasses=c(rep("character", 5), rep("NULL", 8), "character", rep("NULL", 35), "character", rep("NULL", 3)), col.names=c("FILEID", "STUSAB", "SUMLEVEL", "COMPONENT", "LOGRECNO", "TRACT", "Name"))))
